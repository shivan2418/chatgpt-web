<script lang="ts">
    ...
    import { continueMessage, deleteMessage, deleteSummaryMessage, submitExitingPromptsNow, truncateFromMessage, updateMessages } from './Storage.svelte'
    import { getPrice } from './Stats.svelte'
    import SvelteMarkdown from 'svelte-markdown'
    import type { Chat, Message, Model } from './Types.svelte'
    ...
    const checkTruncate = () => {
      if (!waitingForTruncateConfirm) {
        ...
        waitingForTruncateConfirm = setTimeout(() => {
